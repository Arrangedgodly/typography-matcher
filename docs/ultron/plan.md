...
**T01 · O · Repo + Vite scaffold** — `small` · `pending`
...
**T02 · P/F · Pairing schema** — `small` · `pending`
...
**T03 · P · Dummy essay copy** — `small` · `pending`
...
**T04 · F · Font-loading engine** — `medium` · `pending` · *research-informed (R2, non-blocking)*
...
**T05 · F · Dummy page + CSS-variable swap** — `small` · `pending`
...
**T06 · F · Deck logic (pure)** — `small` · `pending`
...
**T07 · D/F · Commit the Examination Room world** — `medium` · `pending`
...
**T08 · F · Input parity** — `medium` · `pending`
...
**T09 · D/F · The lens-swap moment** — `medium` · `pending`
...
**T10 · F · Storage layer** — `small` · `pending`
...
**T11 · F · Saved list (reveal)** — `medium` · `pending`
...
**T14 · P · Curate ~60 pairings** — `medium` · `pending`
...
**T15 · O · Google Fonts validation script** — `small` · `pending`
...
**T16 · Q · E2E happy path** — `medium` · `pending`
...
**T17 · Q · Accessibility walkthrough** — `small` · `pending`
...
**T18 · O · GitHub Pages prep** — `small` · `pending` · **publish = halt**
